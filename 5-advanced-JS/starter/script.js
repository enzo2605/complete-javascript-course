...
//Istanza dell'oggetto Person
var john = new Person('John', 1990, 'teacher', 'Smith');
...
var obj2 = obj1;
//qualsiasi variazione su obj1 si riversa su obj2 in quanto obj2 punta a obj1
obj1.age = 30;
...
interviewQuestion('designer')('Vincenzo');
...
var john = {
    ...
    presentation: function (style, timeOfDay) {
        if(style === 'formal') {
            ...
            console.log('Hey! What\'up? I\'m' + this.name + ', I\'m' + this.job + ' I\'m ' + this.age + ' years old. Have a nice ' + timeOfDay);
        }
    }
};
...
console.log(a);
var japan = arrayCalc(a, isFullAge.bind(this, 20));
console.log(japan);
*/
...
(function () {
    ...
    //5.
    //var ans = parseInt(prompt('Select the correct answer'));
